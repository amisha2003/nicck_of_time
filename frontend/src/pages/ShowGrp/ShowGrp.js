...
function ShowGrp(props) {
  ...
  useEffect(() => {
    var config = {
      method: "get",
      url: `https://test-anu1.herokuapp.com/getgroup/${props.match.params.id}`,
      headers: {
  ...
  function handleClick(event) {
    ...
    var config = {
      method: "post",
      url: `https://test-anu1.herokuapp.com/getgroup/adduser/${props.match.params.id}`,
      headers: {
        Authorization: "Bearer" + window.localStorage.getItem("usertoken"),
  ...
  function dltUsr(id) {
    ...
    var config = {
      method: "post",
      url: `https://test-anu1.herokuapp.com/group/removeuser/${props.match.params.id}/${id}`,
      headers: {
        Authorization: "Bearer" + window.localStorage.getItem("usertoken"),
      },
      data: data,
