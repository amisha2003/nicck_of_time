...
//     var config = {
//       method: "post",
//       url: "https://newfilenew.herokuapp.com/signup",
//       headers: {
...
//       <form onSubmit={handleClick} className="formlBody_">
//         <div className="form-ex">
//           <label htmlFor="name" className="my-cl4">
//             Enter your name{" "}
//           </label>
//           <br />
//           <input
...
//         </div>
//         <div className="form-ex">
//           <label htmlFor="email" className="my-cl4">
//             Enter your Email Id{" "}
//           </label>
//           <br />
//           <input
...
//         </div>
//       </form>
//       <span className="picpart">
//       <img className="imgg" src={mainImage} alt="fireSpot" />
//       </span>
//     </div>
//     </div>
//   );
...
function Sign() {
  ...
  function handleClick(event) {
    ...
    var config = {
      method: "post",
      url: "https://test-anu1.herokuapp.com/signup",
      headers: {
        "Content-Type": "application/json",
      },
      data: userDetail,
